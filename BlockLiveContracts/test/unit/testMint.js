...
describe("Test EncryptedERC20 Unit Tests", function () {
    ...
    async function deploymentFixture() {
        ...
        console.log("Deployed ERC20 Contract at Address: ", erc20Contract.address);
        ...
        // priceData.priceBase[2].currencyAddress = erc20Contract.address;
        // priceData.priceBase[4].currencyAddress = erc20Contract.address;
    ...
    describe("test mint", function () {
        describe("success", function () {
            it("should mint the ERC20 Tokens", async () => {
                ...
                console.log("Encrypted Minting Amount: ", encryptedMintingAmount);
